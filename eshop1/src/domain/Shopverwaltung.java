...
public class Shopverwaltung {
	 ...
	 * Bei Existieren des Artikels wird Bestand nicht ge�ndert.
	 * 
...
public boolean fuegeMitarbeiterAccountEin(String name, String passwort) throws AccountExistiertBereitsException{
	...
	/**
	 * Methode zum Einf�gen eines Kunden - Accounts
	 * 
	 * @param name Kundenname
	 * @param passwort Kundenpasswort
	 * @param strasse Stra�e
	...
	/**
	 * Methode zum �ndern des Bestands
	 * 
	...
	/**
	 * Methode, um Artikel in den Warenkorb einzuf�gen
	 * 
	 * @param art Artikel
