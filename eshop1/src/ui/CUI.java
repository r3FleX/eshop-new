...
public class CUI {
	...
	private void menueKunde() {
		...
		System.out.println("[nicht vollst�ndig impelemtiert(16.4)] Warenkorb - Bestellung abschliessen: b \n");
	...
	private void menueMitarbeiter() {
		...
		System.out.println("Artikel ausgeben: a");
		System.out.println("Artikel ordnen: o");
		System.out.println("[nicht implementiert] Artikelmenge �ndern: z \n");
	...
	private void verarbeiteEingabe(String line) throws IOException {
		...
		//TODO @stefan Artikelmenge �ndern "z"
		//TODO @alle bug fixen
