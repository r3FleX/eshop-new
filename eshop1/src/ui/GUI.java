...
public class GUI extends JFrame implements ActionListener, MouseListener {
	...
	// gehˆrt zu Melek = Artikelliste Ausgabe Versuch
	...
	JButton einfuegeButton = new JButton("Einf¸gen");
	...
	class SuchListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent ae) {
			...
			// // }
			// // Alternative 2: Ausgabe des Suchergebnisses ¸ber JTable
			// ArtikelTableModel tModel = (ArtikelTableModel) ausgabeTabelle
			// .getModel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (command.equals("Beenden")) {
				...
				if (user instanceof Kunde) {
					...
					suchen.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							// Alternative 1: Ausgabe des Suchergebnisses ¸ber
							// JList
							// DefaultListModel lModel = (DefaultListModel)
							// ausgabeListe.getModel();
							// lModel.removeAllElements();
							...
							// lModel.addElement(aktBuch);
							// }
							// Alternative 2: Ausgabe des Suchergebnisses ¸ber
							// JTable
							ArtikelTableModel tModel = (ArtikelTableModel) ausgabeTabelle
									.getModel();
							tModel.setDataVector(suchErgebnis);
					...
					// alles f¸r links oben

					left_up.setBorder(BorderFactory
							.createTitledBorder("Neuen Artikel einf¸gen"));
					...
					// TODO einf¸gen noch nicht implementiert

					// alles f¸r links unten
					...
					// alles f¸r rechts
					JButton bestandAendern = new JButton("Bestand ‰ndern");
					JButton loeschen = new JButton("Artikel lˆschen");
					// JButton packungAendern = new
					// JButton("Packungsgrˆﬂe ‰ndern");
					...
					if (Integer.parseInt(plzFeld.getText()) > 99999
						...
						JOptionPane
								.showMessageDialog(null,
										"Bitte geben Sie eine g¸ltige Postleitzahl ein!");
					}
		...
		else if (command.equals("Einf¸gen")) {
			...
			try {
				...
				if (nein.isSelected()) {
					...
					JOptionPane.showMessageDialog(null,
							"Artikel wurde eingef¸gt.");

				}
				// else if (ja.isSelected()) {
				// System.out.println("ja");
				// massengut = true;
				// JFrame packung = new JFrame("Packungsgrˆﬂe festlegen");
				// JLabel packungsgr = new JLabel("Packungsgrˆﬂe:");
		...
		else if (command.equals("Bestand ‰ndern")) {

			final JFrame bestand = new JFrame("Bestand ‰ndern");
			...
			// 0)) == null) {
			// JOptionPane.showMessageDialog(null, "Kein Artikel ausgew‰hlt!");
			// }
			// else {
		...
		// else if (command.equals("Artikelmenge ‰ndern")) {
		// JOptionPane.showMessageDialog(null,
		...
		// }
			...
			gesamt.setText("Gesampreis: " + gesamtpreis + "Ä");
	...
	public void mouseClicked(MouseEvent me) {
		...
		if (me.getSource().equals(ja)) {
			...
			// // TODO Artikel einf¸gen hier rein (AktionListener)
